...
int main()
{
		...
		{
		cout<<"Apologies, you may have failed to type the shape you wanted correctly or requested for a shape whose calculations we cannot yield at the moment."<<endl;
